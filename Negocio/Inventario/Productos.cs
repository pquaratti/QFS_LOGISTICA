...
namespace Negocio.Inventario
{
    public class Productos : NegocioBase<Producto>
    {
        ...
        {
            if (obj.RubroProducto == null || obj.RubroProducto.rubpro_id <= 0)
                throw new Exception("Debe seleccionar un rubro.");
            if (obj.CategoriaProducto == null || obj.CategoriaProducto.catpro_id <= 0)
                throw new Exception("Debe seleccionar una categoría.");
            if (obj.SubcategoriaProducto == null || obj.SubcategoriaProducto.subcatpro_id <= 0)
        ...
        public override Producto Mapear(DataRow dr)
        {
            ...
            obj.SubcategoriaProducto = SubcategoriasProductos.MapearStatic(dr);
        ...
        protected override string QueryDefault(string sTOP, string sWHERE, string sOrderBy)
        {
            ...
            sQuery += "LEFT JOIN Rubros_Productos ON rubpro_id = pro_rubpro_id ";
            sQuery += "LEFT JOIN Categorias_Productos ON catpro_id = pro_catpro_id ";
            sQuery += "LEFT JOIN Subcategorias_Productos ON subcatpro_id = pro_subcatpro_id ";
