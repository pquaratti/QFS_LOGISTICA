CREATE TABLE [dbo].[Zonas_Logisticas] (
    ...
    [zonlog_depo_id]     INT             NULL,
    [zonlog_nombre]      NVARCHAR (50)   NULL,
    [zonlog_descripcion] NVARCHAR (MAX)  NULL,
    [zonlog_codigo]      NVARCHAR (20)   NULL,
    [zonlog_x]           DECIMAL (18, 2) NULL,
    [zonlog_y]           DECIMAL (18, 2) NULL,
    [zonlog_largo]       DECIMAL (18, 2) NULL,
    [zonlog_ancho]       DECIMAL (18, 2) NULL,
    [zonlog_color]       NVARCHAR (20)   NULL,
